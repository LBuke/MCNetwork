package me.lukebingham.gta.guns.type.submachine;
...
import me.lukebingham.gta.guns.attributes.SubMachine;
...
@Range(3.0f)
@Dev
public final class VomFeuerMachinePistol implements SubMachine, BuyableWeapon, UnlockableWeapon {
    ...
    public final String getName() {
        return "Vom Feuer Machine Pistol";
    }
