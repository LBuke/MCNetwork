 ...
 */
public final class VehicleBreaks extends MockEnchantment implements EnchantmentTier {

    /**
     * Construct new enchantment
     */
    public VehicleBreaks() {
        super(102);
    }
    ...
    public String[] getTiers() {
        return new String[]{"Street", "Sport", "Race"};
    }
}
